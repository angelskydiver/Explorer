...
function ChartBox(props: PropsType) {
  ...
  return (
    <div className="h-full overflow-x-hidden">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-10 pr-10">
        <div className="flex items-center bg-green-background p-5 rounded-normal">
              ...
              <button
                ...
                className={`text-10 w-[86px] md:w-[90px] md:text-14 rounded-soft px-15 py-5 md:py-10 font-normal	 ${
                  currentDays === filterItem.days
                    ? 'bg-primary-500 text-baseForeground'
          ...
          return (
            <div
              ...
              <div className="flex items-center mr-20">
                <span
                  className={`w-[0.25rem] md:w-[0.375rem] h-[0.25rem] md:h-[0.375rem] mr-5 rounded-full bg-secondary-600`}></span>
