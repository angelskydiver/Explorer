...
function SearchInput(props: PropTypes) {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className={`bg-none md:none flex justify-center md:justify-start items-center border border-primary-500 ${
        roundedFull
          ? 'rounded-full py-2.5 w-full'
          : 'rounded-soft md:py-8 w-full md:w-[60%]'
      } flex-col md:flex-row`}>
      <div
        className={`w-full bg-transparent md:bg-none  
      ${
        roundedFull
          ? 'rounded-full px-2.5'
       ...
       flex justify-between items-center`}>
        <div className="flex justify-start w-full items-center">
          ...
          <input
            ...
            className={`w-11/12 outline-none focus:outline-none focus-visible:outline-none overflow-hidden whitespace-nowrap	text-ellipsis font-normal text-neutral-200 bg-transparent focus:outline-0 text-12 md:text-16 ${className}`}
            placeholder={
