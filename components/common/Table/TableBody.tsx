    ...
    <div className="w-full">
      {data.map((item) => {
        ...
        return (
          <div
            key={requestId}
            className="w-full flex flex-col p-15 mt-15 md:mt-0 md:p-0 rounded-micro md:border-b md:-rounded-none md:grid md:grid-cols-11 bg-transparent md:bg-transparent md:hover:bg-secondary md:even:bg-transparent ">
            {columns.map((col) => {
